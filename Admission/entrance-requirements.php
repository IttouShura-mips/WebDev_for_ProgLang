...
<head>
    ...
    <title>Entrance Requirements | College of Information and Computer Studies</title>
...
<body>
    ...
    <header class="about-hero">
        <div class="about-hero-content">
            ...
            <h1>ENTRANCE <span>REQUIREMENTS</span></h1>
        </div>
    </header>

    <!-- Main Content Layout with Sidebar and Admission Requirements Info -->
    <div class="content-wrapper">
        ...
        <aside class="related-menu">
            ...
            <ul class="side-menu-list">
                ...
                <li class="active"><a href="entrance-requirements.php"><i class="fa-solid fa-file-signature"></i> Entrance Requirements</a></li>
        ...
        <main class="info-card" id="mainInfoCard">
            ...
            <div class="breadcrumb">
                <i class="fa-solid fa-house"></i> Home » Admission » <span>Entrance Requirements</span>
            </div>
            ...
            <div id="editableContent" class="dynamic-flow-container">
                ...
                <div class="section-block">
                    ...
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false">1. FOR FRESHMEN</h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">ALL applicants must comply with the following requirements:</p>
                    <div class="element-controls">
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>1.1 Completed Application Form</li>
                        <li>1.2 Form 138</li>
                        <li>1.3 Passed the Entrance Examination & Interview</li>
                        <li>1.4 Two (2) Copies of 2 x 2 photo</li>
                        <li>1.5 Certification of Good Moral Character</li>
                        <li>1.6 Other requirements as maybe deemed necessary by the College Admissions Committee</li>
                    </ul>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false">2. FOR TRANSFEREES</h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false"></p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>2.1 Completed Application Form</li>
                        <li>2.2 Transfer Credential</li>
                        <li>2.3 Certified thru copy of grades from the school last attended for evaluation purposes</li>
                        <li>2.4 Passed the entrance examination & interview</li>
                        <li>2.5 Two (2) copies of 2 x 2 photo</li>
                        <li>2.6 Recommendation and certification of good moral character</li>
                    </ul>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false">3. FOR FOREIGN STUDENTS</h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false"></p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>3.1 Completed application form</li>
                        <li>3.2 Certified thru copy of grades from the school last attended for evaluation purposes</li>
                        <li>3.3 Passed the entrance examination and interview</li>
                        <li>3.4 Recommendation and Certification of good moral character</li>
                        <li>3.5 Two (2) copies of 2 x 2 photo</li>
                        <li>3.6 Verified copy of Alien Certificate of Registration (ACR)</li>
                        <li>3.7 Verified copy of passport</li>
                        <li>3.8 Copy of Certificate of Eligibility for admission (CEA) from the Commission on Higher Education (CHED)</li>
                    </ul>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false">ENROLLMENT</h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false"></h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">
                        A student is considered officially enrolled for the semester if he/she has paid his/her tuition fee and other fees either partially or in full and after his/her course cards are issued by the Office of the College Registrar.<br><br>
                        For an orderly and systematic enrollment, a year level registration schedule is followed with a different day set aside for the irregular students.<br><br>
                        Students are required to register personally; however, the College Registrar and the Dean considered a case-to-case basis registration by proxy.
                    </p>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false">REQUIREMENTS AND PROCEDURES</h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false"></h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">The following steps are followed for registration of new students:</p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>1. Secure Letter of Acceptance from the Office of Admissions</li>
                        <li>2. Submit to the Office of the College Registrar the following:
                            <ul class="nested-procedure-list">
                                <li>2.1 Form 137, Form 138 (for freshman)</li>
                                <li>2.2 Transfer Credential (for transferees)</li>
                            </ul>
                        </li>
                        <li>3. Secure a copy of registration form</li>
                        <li>4. Proceed to the Accounting Office for assessment, billing and payment</li>
                        <li>5. Submit final registration form and secure course cards to/from the Office of the College Registrar.</li>
                        <li>6. Obtain library card and school identification card from the College Library and Office of Students Affairs and Discipline respectively</li>
                    </ul>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false"></h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">The following steps are followed for registration of old students:</p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>1. Secure pre-enrollment clearance from the Office of Student Affairs and Discipline</li>
                        <li>2. Get a copy registration form</li>
                        <li>3. Proceed to the Accounting Office for assessment, billing and payment</li>
                        <li>4. Submit final registration form and secure course cards to/from the Office of the College Registrar</li>
                        <li>5. Renew library card and validate school identification card from the College Library and Office of Student Affairs and Discipline respectively</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        const STORAGE_KEY = 'entrance_requirements_content';
        ...
        function toggleListType(buttonEl, type) {
            const section = buttonEl.closest('.section-block');
        ...
        function removeBlock(buttonEl) {
            const block = buttonEl.closest('.section-block');
            if (block) {
                block.remove();
            }
        }
        ...
        addInfoBtn.addEventListener('click', () => {
            ...
            newBlock.innerHTML = `
                ...
                <!-- Main Section Header -->
                <h2 class="main-header-title editable-field" data-placeholder="Enter Main Header..." contenteditable="true"></h2>
                
                <!-- Sub Header -->
                <h3 class="section-subtitle editable-field" data-placeholder="Enter Sub Header (Optional)..." contenteditable="true"></h3>
                
                <!-- Subtitle / Description -->
                <p class="subtitle editable-field" data-placeholder="Enter Description / Subtitle context (Optional)..." contenteditable="true"></p>
