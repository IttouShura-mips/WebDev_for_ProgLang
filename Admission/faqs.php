...
<head>
    ...
    <title>Frequently Asked Questions | College of Information and Computer Studies</title>
    ...
    <style>
        * {
        ...
        /* Dynamic Flow Container & Spacing */
        ...
        /* Dynamic Element Controls Toolbar */
        .element-controls {
            display: none;
            gap: 8px;
            margin-top: 6px;
        ...
        .faq-item.active .faq-bullet-indicator::before {
            content: "\f061";
        ...
        .faq-answer {
            max-height: 0;
            overflow: hidden;
            transition: max-height 0.35s cubic-bezier(0, 1, 0, 1), padding 0.35s ease-out, opacity 0.25s ease-out;
        ...
        body.is-editing-mode .faq-answer {
...
<body>
    ...
    <!-- Main Content Layout with Sidebar and FAQ Info -->
    <div class="content-wrapper">
        ...
        <aside class="related-menu">
            ...
            <ul class="side-menu-list">
                ...
                <li><a href="scholarship-opportunities.php"><i class="fa-solid fa-graduation-cap"></i> Scholarship Opportunities</a></li>
                <li class="active"><a href="faqs.php"><i class="fa-solid fa-circle-question"></i> Frequently Asked Questions</a></li>
            </ul>
        </aside>
        ...
        <main class="info-card" id="mainInfoCard">
            ...
            <div class="breadcrumb">
                <i class="fa-solid fa-house"></i> Home » Admission » <span>FAQs</span>
            </div>
            ...
            <div id="editableContent" class="dynamic-flow-container">
                ...
                <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">Find quick answers to common queries regarding entrance requirements, admissions, curriculum, fees, and scholarship applications.</p>

                <!-- Section Block: Entrance Requirements FAQs -->
                <div class="section-block">
                    <div class="element-controls">
                        <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Category Section</button>
                        <button class="ctrl-btn" onclick="addFaqItem(this)"><i class="fa-solid fa-plus"></i> Add Question</button>
                    </div>
                    <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="false">Entrance Requirements</h3>
                    <ul class="faq-list">
                        <li class="faq-item">
                            <div class="element-controls">
                                <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                            </div>
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What are the requirements for fresh high school graduates?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Fresh graduates must submit Form 138-A (High School Report Card), Form 137-A, a Certificate of Good Moral Character, two identical 2x2 ID photos, and a clear photocopy of their PSA Birth Certificate.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What credentials do transferees need to submit?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Transferees must provide an Honorable Dismissal or Certificate of Transfer Credential, an Official Transcript of Records (TOR) or Certificate of Grades for evaluation, a Certificate of Good Moral Character, two 2x2 ID photos, and a photocopy of their PSA Birth Certificate.
                            </div>
                        </li>
                    </ul>
                </div>

                <!-- Section Block: Admission Procedures FAQs -->
                <div class="section-block">
                    <div class="element-controls">
                        <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Category Section</button>
                        <button class="ctrl-btn" onclick="addFaqItem(this)"><i class="fa-solid fa-plus"></i> Add Question</button>
                    </div>
                    <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="false">Admission Procedures</h3>
                    <ul class="faq-list">
                        <li class="faq-item">
                            <div class="element-controls">
                                <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What factors are evaluated during the applicant selection process?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Selection is based on prior academic performance, results from the ICF Inc. College Entrance Examinations, a recommendation letter from previous school officials, and an interview.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">How does the step-by-step admission process work?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Applicants must pay the application fee at the Accounting Office to get application materials, submit the required documents, take the scheduled entrance exam, and await results (released within three days). Qualified and wait-listed applicants then complete an interview with the Dean or Department Chair.
                            </div>
                        </li>
                    </ul>
                </div>

                <!-- Section Block: Curriculum & Degree Offerings FAQs -->
                <div class="section-block">
                    <div class="element-controls">
                        <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Category Section</button>
                        <button class="ctrl-btn" onclick="addFaqItem(this)"><i class="fa-solid fa-plus"></i> Add Question</button>
                    </div>
                    <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="false">Curriculum & Degree Offerings</h3>
                    <ul class="faq-list">
                        <li class="faq-item">
                            <div class="element-controls">
                                <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What four-year undergraduate programs are offered?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                The institution offers Bachelor of Science degrees in Criminology, Information Technology (BSIT), and Elementary Education (BEEd).
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Are two-year vocational or associate programs available?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Yes, students can enroll in two-year programs including Associate in Computer Technology (ACT), Computer Secretarial, Hotel and Restaurant Management, Health Care Services, and Midwifery.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Are non-degree or short courses offered for specialized skills?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Yes, short-term training programs in computer hardware servicing, basic programming, and emergency medical services are available.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Can students shift programs or credit subjects taken from other institutions?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Subject crediting and program shifting are permitted following a formal transcript review by the Department Head or Dean.
                            </div>
                        </li>
                    </ul>
                </div>

                <!-- Section Block: Tuition Fees & Payments FAQs -->
                <div class="section-block">
                    <div class="element-controls">
                        <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Category Section</button>
                        <button class="ctrl-btn" onclick="addFaqItem(this)"><i class="fa-solid fa-plus"></i> Add Question</button>
                    </div>
                    <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="false">Tuition Fees & Payments</h3>
                    <ul class="faq-list">
                        <li class="faq-item">
                            <div class="element-controls">
                                <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">How are tuition fees structured and collected?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Tuition is calculated on a per-unit basis, alongside standard registration, laboratory, and miscellaneous fees.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What payment schedules or plans are available to students?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Fees can be paid in full during registration or through an installment plan divided across Prelim, Midterm, and Final exam periods.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What happens if a student misses a payment deadline during the term?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Students with overdue balances must secure a temporary exam permit from the Accounting Office prior to taking major exams.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Are examination permits required before taking major exams?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Yes, official exam permits are issued upon settled account balances or approved payment arrangements before each examination period.
                            </div>
                        </li>
                    </ul>
                </div>

                <!-- Section Block: Scholarships & Financial Aid FAQs -->
                <div class="section-block">
                    <div class="element-controls">
                        <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Category Section</button>
                        <button class="ctrl-btn" onclick="addFaqItem(this)"><i class="fa-solid fa-plus"></i> Add Question</button>
                    </div>
                    <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="false">Scholarships & Financial Aid</h3>
                    <ul class="faq-list">
                        <li class="faq-item">
                            <div class="element-controls">
                                <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Does the institution offer academic scholarships for incoming freshmen?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Yes, full tuition waivers are awarded to High School Valedictorians, while Salutatorians receive a 50% discount on tuition fees.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Are there financial discounts for family members enrolling together?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                A sibling discount is available: when two or more siblings enroll concurrently, a 10% tuition discount is applied to each student.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">Does the school accept government grants or TESDA/CHED subsidies?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Eligible students may apply government tertiary education subsidies and accredited financial assistance programs toward their tuition balance.
                            </div>
                        </li>
                        <li class="faq-item">
                            <div class="element-controls">
                            ...
                            <button class="faq-question">
                                <span class="faq-bullet-indicator"></span>
                                <span class="editable-field" data-placeholder="Enter Question..." contenteditable="false">What are the maintaining requirements for scholarship retention?</span>
                            </button>
                            <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="false">
                                Scholarship recipients must maintain a minimum general weighted average (GWA) and avoid any failing or incomplete grades per semester.
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <!-- Add Info Category Section Button -->
            <div class="add-info-container">
                <button class="btn-add-info" onclick="addCategorySection()">
                    <i class="fa-solid fa-plus"></i> Add New Category Section
                </button>
            </div>
        </main>
    </div>
    ...
    <script>
        ...
        function setupFaqAccordion() {
            ...
            faqQuestions.forEach(question => {
                question.onclick = (e) => {
                    if (document.body.classList.contains('is-editing-mode')) return;
        ...
        const STORAGE_KEY = 'faqs_page_content';
        ...
        adminEditBtn.addEventListener('click', () => {
            const isEditing = document.body.classList.toggle('is-editing-mode');
            const editableFields = editableContent.querySelectorAll('.editable-field');

            if (isEditing) {
                adminEditBtn.classList.add('is-updating');
                adminEditBtn.querySelector('span').textContent = 'Update';
                adminEditBtn.querySelector('i').className = 'fa-solid fa-floppy-disk';
                ...
                adminEditBtn.querySelector('span').textContent = 'Edit';
                adminEditBtn.querySelector('i').className = 'fa-solid fa-pen-to-square';

                editableFields.forEach(field => {
                    field.setAttribute('contenteditable', 'false');
                });

                // Remove active accordion states before saving
                document.querySelectorAll('.faq-item').forEach(item => {
                    item.classList.remove('active');
                    item.querySelector('.faq-answer').style.maxHeight = null;
                });
        ...
        function removeBlock(button) {
            const block = button.closest('.section-block, .faq-item');
            if (block && confirm('Are you sure you want to delete this element?')) {
                block.remove();
            }
        }

        function addFaqItem(button) {
            const faqList = button.closest('.section-block').querySelector('.faq-list');
            if (!faqList) return;
            ...
            newItem.innerHTML = `
                ...
                <button class="faq-question">
                    <span class="faq-bullet-indicator"></span>
                    <span class="editable-field" data-placeholder="Enter Question..." contenteditable="true">New Question Title</span>
                </button>
                <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="true">
                    Enter the answer details here...
                </div>
            `;
        ...
        function addCategorySection() {
            ...
            newSection.innerHTML = `
                ...
                <h3 class="faq-category-title editable-field" data-placeholder="Category Title..." contenteditable="true">New FAQ Category</h3>
                <ul class="faq-list">
                    <li class="faq-item">
                        <div class="element-controls">
                            <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete FAQ</button>
                        ...
                        <button class="faq-question">
                            <span class="faq-bullet-indicator"></span>
                            <span class="editable-field" data-placeholder="Enter Question..." contenteditable="true">Sample Question?</span>
                        </button>
                        <div class="faq-answer editable-field" data-placeholder="Enter Answer..." contenteditable="true">
                            Sample answer explanation text goes here.
                        </div>
                    </li>
                </ul>
            `;
            editableContent.appendChild(newSection);
            setupFaqAccordion();
        }
