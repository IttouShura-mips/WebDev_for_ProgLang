...
<head>
    ...
    <title>Enrollment Schedule | College of Information and Computer Studies</title>
    ...
    <style>
        * {
        ...
        .announcement-box .academic-year {
            font-family: 'JetBrains Mono', monospace;
            font-size: 1.1rem;
            font-weight: 700;
            color: var(--primary-neon);
...
<body>
    ...
    <header class="about-hero">
        <div class="about-hero-content">
            ...
            <h1>ENROLLMENT <span>SCHEDULE</span></h1>
        </div>
    </header>

    <!-- Main Content Layout with Sidebar and Enrollment Schedule Info -->
    <div class="content-wrapper">
        ...
        <aside class="related-menu">
            ...
            <ul class="side-menu-list">
                ...
                <li class="active"><a href="enrollment-schedule.php"><i class="fa-solid fa-calendar-days"></i> Enrollment Schedule</a></li>
        ...
        <main class="info-card" id="mainInfoCard">
            ...
            <div class="breadcrumb">
                <i class="fa-solid fa-house"></i> Home » Admission » <span>Enrollment Schedule</span>
            </div>
            ...
            <div id="editableContent" class="dynamic-flow-container">
                <h1 class="info-title editable-field" data-placeholder="Enter Main Title..." contenteditable="false">
                    <i class="fa-solid fa-calendar-check"></i> Extended Enrollment Schedule
                </h1>
                <p class="subtitle editable-field" data-placeholder="Enter Subtitle..." contenteditable="false">
                    Interworld Colleges Foundation, Inc. - Official Enrollment Extension Details
                </p>
                ...
                <div class="section-block">
                    ...
                    <div class="announcement-box">
                        <div class="academic-year editable-field" data-placeholder="Academic Year..." contenteditable="false">ACADEMIC YEAR 2026 – 2027</div>
                        <div class="notice-text editable-field" data-placeholder="Announcement text..." contenteditable="false">Good news! Enrollment has been extended. Don't miss this opportunity to secure your slot for the School Year 2026–2027.</div>
                        
                        <div class="date-badge-container">
                            <div class="date-card">
                                <div class="month editable-field" data-placeholder="Month" contenteditable="false">June</div>
                                <div class="day editable-field" data-placeholder="Day" contenteditable="false">22</div>
                            </div>
                            <div class="date-separator">–</div>
                            <div class="date-card">
                                <div class="month editable-field" data-placeholder="Month" contenteditable="false">June</div>
                                <div class="day editable-field" data-placeholder="Day" contenteditable="false">26</div>
                            </div>
                        </div>
                    </div>

                    <ul class="enrollment-details">
                        <li><i class="fa-solid fa-location-dot"></i> <strong>Location:</strong> <span class="editable-field" data-placeholder="Location..." contenteditable="false">Burgos St., Paniqui, Tarlac</span></li>
                        <li><i class="fa-solid fa-phone"></i> <strong>Contact:</strong> <span class="editable-field" data-placeholder="Contact No..." contenteditable="false">(045) 470-8645</span></li>
                        <li><i class="fa-brands fa-facebook"></i> <strong>Facebook:</strong> <span class="editable-field" data-placeholder="Facebook Page..." contenteditable="false">ICF, Inc Paniqui Media and Information</span></li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        const STORAGE_KEY = 'enrollment_schedule_content';
        ...
        addInfoBtn.addEventListener('click', () => {
            ...
            newBlock.innerHTML = `
                ...
                <!-- Main Section Header -->
                <h2 class="main-header-title editable-field" data-placeholder="Enter Main Header..." contenteditable="true">Enrollment Information</h2>
                ...
                <ul class="procedure-list editable-field" contenteditable="true">
                    <li>New schedule detail or instruction...</li>
                </ul>
            `;
