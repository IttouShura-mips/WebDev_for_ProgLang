...
<head>
    ...
    <title>Admission Procedures | College of Information and Computer Studies</title>
    ...
    <style>
        * {
        ...
        .section-block {
            ...
            display: flex;
            flex-direction: column;
            gap: 0.5rem; /* Dynamic internal gap adjustment */
            padding: 12px;
            border-radius: 8px;
            transition: var(--transition-smooth);
        }
...
<body>
    ...
    <header class="about-hero">
        <div class="about-hero-content">
            ...
            <h1>ADMISSION <span>PROCEDURES</span></h1>
        </div>
    </header>

    <!-- Main Content Layout with Sidebar and Admission Procedures Info -->
    <div class="content-wrapper">
        ...
        <aside class="related-menu">
            ...
            <ul class="side-menu-list">
                <li class="active"><a href="admission-procedures.php"><i class="fa-solid fa-clipboard-list"></i> Admission Procedures</a></li>
        ...
        <main class="info-card" id="mainInfoCard">
            ...
            <div class="breadcrumb">
                <i class="fa-solid fa-house"></i> Home » Admission » <span>Procedures</span>
            </div>
            ...
            <div id="editableContent" class="dynamic-flow-container">
                ...
                <div class="section-block">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false">Admission Policies and procedures</h2>
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false">Selection Credentials</h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">The following credentials are considered in selecting the applicants for admission:</p>
                    <div class="element-controls">
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li>Academic performance in previous school</li>
                        <li>ICF INC., College Entrance Examinations</li>
                        <li>Recommendation from officials of previous school</li>
                        <li>Interview</li>
                    </ul>
                </div>
                ...
                <div class="section-block">
                    ...
                    <h3 class="section-subtitle editable-field" data-placeholder="Sub Header..." contenteditable="false">Admission Process</h3>
                    <p class="subtitle editable-field" data-placeholder="Subtitle / Description..." contenteditable="false">The Applicant should undergo the following process:</p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    </div>
                    <ol class="procedure-ordered-list editable-field" contenteditable="false">
                        <li>Get the application form and other materials from the office of the admissions after payment of application and processing fees at the Accounting Office.</li>
                        <li>The applicant should submit within the specified period all the requirements.</li>
                        <li>Qualified applicants are scheduled for an entrance examination administered by the Office of the College Admission Committee.</li>
                        <li>After the evaluation of credentials and examination results the College Admission Committee classify all the applicants.</li>
                        <li>Examination results are released by the Office of the College Admissions Committee at least three (3) days after date of testing or as announced by the examiner.</li>
                        <li>Those who were qualified and wait-listed will be scheduled for interview by the respective Chair/Dean.</li>
                    </ol>
                </div>
            </div>
    ...
    <script>
        ...
        const STORAGE_KEY = 'admission_procedures_content';
        ...
        addInfoBtn.addEventListener('click', () => {
            ...
            newBlock.innerHTML = `
                ...
                <!-- Main Section Header -->
                <h2 class="main-header-title editable-field" data-placeholder="Enter Main Header (e.g. Admission Policies and procedures)..." contenteditable="true">Admission Policies and procedures</h2>
