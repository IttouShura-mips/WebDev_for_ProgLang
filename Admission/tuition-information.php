...
<head>
    ...
    <title>Tuition Information | College of Information and Computer Studies</title>
    ...
    <style>
        * {
        ...
        body.is-editing-mode .policy-section {
...
<body>
    ...
    <header class="about-hero">
        <div class="about-hero-content">
            ...
            <h1>TUITION <span>INFORMATION</span></h1>
        </div>
    </header>

    <!-- Main Content Layout with Sidebar and Tuition Info -->
    <div class="content-wrapper">
        ...
        <aside class="related-menu">
            ...
            <ul class="side-menu-list">
                ...
                <li class="active"><a href="tuition-information.php"><i class="fa-solid fa-receipt"></i> Tuition Information</a></li>
        ...
        <main class="info-card" id="mainInfoCard">
            ...
            <div class="breadcrumb">
                <i class="fa-solid fa-house"></i> Home » Admission » <span>Tuition Information</span>
            </div>
            ...
            <div id="editableContent" class="dynamic-flow-container">
                ...
                <p class="subtitle editable-field" data-placeholder="Enter Subtitle / Description..." contenteditable="false">
                    Official financial guidelines, payment options, installment schedules, and refund policies of the institution.
                </p>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 1: Notification of Fees</h3>
                    <p class="editable-field" data-placeholder="Enter policy details..." contenteditable="false">All students are notified about tuition and miscellaneous fees through an official communication from the College President prior to and or during the enrollment period.</p>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 2: Payment Modes & Installment Plan</h3>
                    <p class="editable-field" data-placeholder="Enter policy details..." contenteditable="false">The fees payable to the College may be paid in cash upon enrollment or by installment.</p>
                    <p class="editable-field" style="margin-top: 10px; font-weight: 600;" data-placeholder="Subtitle note..." contenteditable="false">Payment in the installment plan shall be as follows:</p>
                    <div class="element-controls">
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li><strong>2.1 Down Payment:</strong> Upon enrollment, minimum down payment is Php 1,000. The remaining balance will be divided into 3 terms of payment.</li>
                        <li><strong>2.2 Preliminary Examination:</strong> Before Preliminary Examination, prescribed tuition and all fees must be paid including NSTP Fee.</li>
                        <li><strong>2.3 Mid-term Examination:</strong> Before Mid-term Examination, prescribed tuition and all fees must be paid.</li>
                        <li><strong>2.4 Final Examination:</strong> Before Final Examination, all fees must be paid.</li>
                    </ul>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 3 & 4: Educational Privileges & Credentials</h3>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li><strong>Section 3:</strong> Students enjoying the educational benefits must submit their certificate of educational privileges.</li>
                        <li><strong>Section 4:</strong> Students who submit the necessary certificate may be allowed to enroll without payment of the fees. For all the unpaid fees, the College has the right to withhold the release of all records and other student credentials until all his/her accounts are settled in full.</li>
                    </ul>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 5: Transaction Location</h3>
                    <p class="editable-field" data-placeholder="Enter policy details..." contenteditable="false">All financial business is transacted through the Office of the Accounting Department at the Cashier's Office (windows 1 and 2).</p>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 6: Regular Term Refund Policy</h3>
                    <p class="editable-field" data-placeholder="Enter policy details..." contenteditable="false">Claims for refund are made in accordance with the approved school policy as stated below:</p>
                    <div class="quote-box editable-field" data-placeholder="Enter quotation note..." contenteditable="false">
                        "Unless otherwise provided by institutional policies, rules and regulations, a student who transfers or withdraws, can do so in writing within two (2) weeks after the beginning of the classes, and who has already paid the pertinent tuition and other school fees in full. Twenty five percent (25%) of the total amount due for the school term if he/she withdraws within the first week of classes, and fifty percent (50%), within the second week of classes whether or not he has actually attended classes. The student will be charged for all the school fees in full if he/she withdraws any time after the second week of classes. However, the withdrawal is due to justifiable reason, the student shall be charged the pertinent fees only for his/her inclusive months of attendance. Whereas; registration and other pertinent fees are not refundable."
                    </div>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                    ...
                    <ul class="procedure-list editable-field" style="margin-top: 15px;" contenteditable="false">
                        <li><strong>6.1 Transfer Restrictions:</strong> Permission to transfer may be withheld from student if he/she has not fully settled the financial accounts with the school.</li>
                        <li><strong>6.2 Subject Discontinuation:</strong> Full refund of tuition fee shall be made for any course or subject which has been discontinued by the school or not credited through no fault of the students.</li>
                    </ul>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 7: Summer Term Dropping & Refund Policy</h3>
                    <p class="editable-field" data-placeholder="Enter policy details..." contenteditable="false">During the summer, a student who drops from his/her classes shall be charged by the College as:</p>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li><strong>7.1 First and Second Day:</strong> Within the first and second day of classes, he/she shall be charged an amount equal to twenty percent (20%) of tuition for the whole summer term, whether or not he/she has actually attended the classes.</li>
                        <li><strong>7.2 Third and Fourth Day:</strong> Within the third and fourth day of classes, he/she shall be charged an amount equal to fifty percent (50%) of tuition for the whole summer term, whether or not he/she has actually attended the classes.</li>
                        <li><strong>7.3 After Fourth Day:</strong> After the fourth day of classes, he/she shall be charged in full whether or not he/she has actually attended classes.</li>
                        <li><strong>7.4 Non-refundable Fees:</strong> Registration and other pertinent fees are not refundable.</li>
                    </ul>
                </div>
                ...
                <div class="policy-section">
                    ...
                    <h2 class="main-header-title editable-field" data-placeholder="Main Section Header..." contenteditable="false"></h2>
                    <h3 class="section-header editable-field" data-placeholder="Section Subtitle..." contenteditable="false">Section 8 to 11: General Financial Regulations</h3>
                    <div class="element-controls">
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ul')"><i class="fa-solid fa-list-ul"></i> Bullets</button>
                        <button class="ctrl-btn" onclick="toggleListType(this, 'ol')"><i class="fa-solid fa-list-ol"></i> Numbering</button>
                        <button class="ctrl-btn" onclick="addListItem(this)"><i class="fa-solid fa-plus"></i> Add Item</button>
                    ...
                    <ul class="procedure-list editable-field" contenteditable="false">
                        <li><strong>Section 8:</strong> Any student who has been dismissed or expelled from the college is not entitled to any refund of tuition fees.</li>
                        <li><strong>Section 9:</strong> After the second week of classes, in case however that a student has paid his/her account in full or partial, he/she can no longer refund the amount.</li>
                        <li><strong>Section 10:</strong> All school fees will be divided into three examination and to be settled every examination.</li>
                        <li><strong>Section 11:</strong> School Fees- Cash Basis- the actual cost to be paid Installment basis with additional five (5) percent on the total fees.</li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        /* ====================================================
           DYNAMIC EDITING, TOOLBAR, & SECTION BUILDER
        ==================================================== */
        const adminEditBtn = document.getElementById('adminEditBtn');
        const editableContent = document.getElementById('editableContent');
        const addInfoBtn = document.getElementById('addInfoBtn');
        const STORAGE_KEY = 'tuition_information_content';

        // Load saved content from LocalStorage on page load
        document.addEventListener('DOMContentLoaded', () => {
            const savedData = localStorage.getItem(STORAGE_KEY);
            if (savedData) {
                editableContent.innerHTML = savedData;
            }
        });

        // Toggle Edit Mode state globally
        let isEditMode = false;

        adminEditBtn.addEventListener('click', () => {
            isEditMode = !isEditMode;
            document.body.classList.toggle('is-editing-mode', isEditMode);
            const fields = editableContent.querySelectorAll('.editable-field');

            if (isEditMode) {
                fields.forEach(field => field.setAttribute('contenteditable', 'true'));
                adminEditBtn.classList.add('is-updating');
                adminEditBtn.innerHTML = '<i class="fa-solid fa-floppy-disk"></i> <span>Update</span>';
            } else {
        ...
        // Functionality for changing List Type (Unordered/Ordered)
        function toggleListType(buttonEl, type) {
            const section = buttonEl.closest('.policy-section, .section-block');
            const currentList = section.querySelector('ul, ol');
            if (!currentList) return;

            const newList = document.createElement(type);
            newList.className = type === 'ul' ? 'procedure-list editable-field' : 'procedure-ordered-list editable-field';
            newList.setAttribute('contenteditable', isEditMode ? 'true' : 'false');
        ...
        // Add ListItem helper function
        function addListItem(buttonEl) {
            const section = buttonEl.closest('.policy-section, .section-block');
            const list = section.querySelector('ul, ol');
            if (list) {
                const li = document.createElement('li');
                li.textContent = 'New item entry...';
                list.appendChild(li);
            }
        }

        // Section Deletion helper function
        function removeBlock(buttonEl) {
            const block = buttonEl.closest('.policy-section, .section-block');
            if (block) {
                block.remove();
            }
        }

        // Dynamic "Add Info" Section creation with Main Header & Auto-Adjust Spacing Support
        addInfoBtn.addEventListener('click', () => {
            const newBlock = document.createElement('div');
            newBlock.className = 'policy-section';
            newBlock.innerHTML = `
                <div class="element-controls">
                    <button class="ctrl-btn btn-delete" onclick="removeBlock(this)"><i class="fa-solid fa-trash"></i> Delete Section</button>
                </div>
                ...
                <!-- Main Section Header -->
                <h2 class="main-header-title editable-field" data-placeholder="Enter Main Header (Optional)..." contenteditable="true"></h2>
                
                <!-- Sub Header -->
                <h3 class="section-header editable-field" data-placeholder="Enter Section Title (e.g., Section 12: Additional Fees)..." contenteditable="true">Section New: Title Here</h3>
                
                <!-- Subtitle / Description -->
                <p class="editable-field" data-placeholder="Enter Description / Policy Details (Optional)..." contenteditable="true"></p>
                ...
                <ul class="procedure-list editable-field" contenteditable="true">
                    <li>New list item entry...</li>
                </ul>
            `;
